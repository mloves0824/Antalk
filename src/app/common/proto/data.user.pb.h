...
class GetUserInfoReq : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:antalk.data.user.GetUserInfoReq) */ {
 public:
  GetUserInfoReq();
...
class GetUserInfoRes : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:antalk.data.user.GetUserInfoRes) */ {
 public:
  GetUserInfoRes();
