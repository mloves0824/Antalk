...
#ifndef PROTOBUF_user_2elogin_2eproto__INCLUDED
#define PROTOBUF_user_2elogin_2eproto__INCLUDED
...
class LoginReq : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:antalk.user.LoginReq) */ {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_user_2elogin_2eproto();
  friend void protobuf_AssignDesc_user_2elogin_2eproto();
  friend void protobuf_ShutdownFile_user_2elogin_2eproto();
...
inline ::im::base::UserStatType LoginReq::online_status() const {
...
inline void LoginReq::set_online_status(::im::base::UserStatType value) {
...
inline ::im::base::UserStatType LoginRes::online_status() const {
  // @@protoc_insertion_point(field_get:antalk.user.LoginRes.online_status)
  return static_cast< ::im::base::UserStatType >(online_status_);
}
inline void LoginRes::set_online_status(::im::base::UserStatType value) {
  assert(::im::base::UserStatType_IsValid(value));
  set_has_online_status();
  online_status_ = value;
...
inline const ::im::base::UserInfo& LoginRes::user_info() const {
  // @@protoc_insertion_point(field_get:antalk.user.LoginRes.user_info)
  return user_info_ != NULL ? *user_info_ : *default_instance_->user_info_;
}
inline ::im::base::UserInfo* LoginRes::mutable_user_info() {
  set_has_user_info();
  if (user_info_ == NULL) {
...
inline ::im::base::UserInfo* LoginRes::release_user_info() {
...
inline void LoginRes::set_allocated_user_info(::im::base::UserInfo* user_info) {
  delete user_info_;
...
#endif  // PROTOBUF_user_2elogin_2eproto__INCLUDED
