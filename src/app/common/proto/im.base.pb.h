...
class UserInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:im.base.UserInfo) */ {
 public:
  UserInfo();
  virtual ~UserInfo();
...
template <> struct is_proto_enum< ::im::base::UserStatType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::im::base::UserStatType>() {
  return ::im::base::UserStatType_descriptor();
}
